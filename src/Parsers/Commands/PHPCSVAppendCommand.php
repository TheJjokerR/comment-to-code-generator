...
class PHPCSVAppendCommand extends PHPCSVCommand
{
    /**
     * Shorthand to append an array as a string of comma separated values
     * 
     * @note This starts with a comma if there are any values in the given array. If they array is empty it returns an empty string.
     *
